...
def make_generator_helper(args):
    ...
    generator.add_param(
        ...
        group=123456,
        values_and_names=[
            (get_robocasa_ds("TurnOnSinkFaucet", src="mg_nav_fixview", eval=[],
                             filter_key="1500_demos"), "mg-1500-nav"), # training on MimicGen datasets
        ]
    )
    ...
    generator.add_param(
        ...
        name="",
        group=-1,
        values=[get_output_dir(args, algo_dir=algo_name_short) + "nav"]
    )
